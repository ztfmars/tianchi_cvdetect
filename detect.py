...
# 修改了LoadImages, __next__里面path路径
...
def detect(save_img=False):
    ...
    if webcam:
        ...
        save_img = True
        dataset = LoadImagesTest(source, img_size=imgsz, stride=stride)
                    ...
                    if save_json:
                        ...
                        result.append(
                            {'name': img_name + '.jpg', 'category': int(cls + 1), 'bbox': bbox,
                             'score': conf})
                        print("result: ", {'name': img_name + '.jpg', 'category': int(cls + 1), 'bbox': bbox,
                                           'score': conf})
    ...
    if save_json:
        ...
        # print("**"*10)
        # print(os.getcwd())
        # print(os.path.join(save_dir, "result.json"))
        # print("**"*10)
        # shutil.copy(os.path.join(save_dir, "result.json"), os.getcwd())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='./tcdata/guangdong1_round2_testB_20191024',
